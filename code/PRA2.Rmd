...
multi_model_1 = train(Rating~Age+Weight+Club_Position+Vision+Ball_Control+Marking+Interceptions+Freekick_Accuracy+Short_Pass+Speed+Finishing, data=fifaNet, 
...
* Se obtenido un modelo de regresión 
...
```{r message= FALSE, warning=FALSE}
write.csv(fifaNet,"../datos/fifaNet.csv", col.names = T,row.names=F)
write.csv(fifaNet_spain,"../datos/fifaNetSpain.csv", col.names = T,row.names=F)
```
